...
export default function Expertise() {
  return (
    <section id="expertise" className="py-20 px-6 md:px-16 bg-black/50 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {expertiseList.map((item, i) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 shadow-lg transform transition-all duration-300 group hover:!opacity-100 hover:shadow-green-400/20 hover:-translate-y-2"
            >
              <motion.div
